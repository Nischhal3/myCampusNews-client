  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.editProfileIcon} onPress={() => navigation.navigate("EditProfile")}>
        <McIcons name="account-edit-outline" size={28} color={colors.secondary} />
      </TouchableOpacity>
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.infoItemContainer}>
          <View style={styles.infoItemIconText}>
            <McIcons name="phone-outline" size={24} color={colors.dark_text} />
        ...
        <View style={styles.infoItemContainer}>
          <View style={styles.infoItemIconText}>
            <McIcons name="email-outline" size={24} color={colors.dark_text} />
        ...
        <View style={styles.infoItemContainer}>
          <View style={styles.infoItemIconText}>
            <McIcons name="card-account-details-outline" size={24} color={colors.dark_text} />
        ...
        <View style={styles.infoItemContainer}>
          <View style={styles.infoItemIconText}>
            <McIcons name="office-building-marker-outline" size={24} color={colors.dark_text} />
